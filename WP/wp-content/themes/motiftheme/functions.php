...
// Pagination JS
		//wp_enqueue_script( 'jPages-min', get_template_directory_uri() . '/js/jPages.min.js', array( 'jquery' ), '',true );
		
		//wp_enqueue_script( 'Pagination-js', get_template_directory_uri() . '/js/Pagination.js', array( 'jquery' ), '',true );
		// Tabes js 
		
	if(is_page('press')){

			wp_enqueue_script( 'waterfall-js', get_template_directory_uri() . '/js/searchpagination.js', array( 'jquery' ), '',true );
...
echo '<p id="breadcrumbs">
	<span prefix="v: http://rdf.data-vocabulary.org/#">
        <span typeof="v:Breadcrumb"><a property="v:title" rel="v:url" href="'.get_bloginfo('url').'">Home <img alt="breadcrumb-divider.png" src="'.get_template_directory_uri().'/images/breadcrumb-divider.png" class="breadcrumb-spacer"></a></span>
        <img alt="breadcrumb-divider.png" src="'.get_template_directory_uri().'/images/breadcrumb-divider.png" class="breadcrumb-spacer">';
echo '<span typeof="v:Breadcrumb"><a property="v:title" rel="v:url" href="'.$url.'/motifs/">Motifs</a></span><img alt="breadcrumb-divider.png" src="'.get_template_directory_uri().'/images/breadcrumb-divider.png" class="breadcrumb-spacer">';
...
echo '<span typeof="v:Breadcrumb"><span property="v:title" class="breadcrumb_last">'.$term->name.'</span></span>';
echo '</span></p>';
}
