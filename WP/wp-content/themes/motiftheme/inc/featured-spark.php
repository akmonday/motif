<div class="featured-spark yo">
    <?php
        if ( motiftheme_has_featured_posts() ) {
    ?>
        <div id="carousel-featured-content" class="carousel slide" data-ride="carouselfalse">
            
                <div id="featured-content" class="featured-content">
                    <div class="featured-content-inner">

                         <div class="carousel-inner w-container" role="listbox">
                            <?php
                                $counter = 0;
                                ...
                                <div class="item <?php if ($counter == 0) {
                                    ...
                                    <div id="post-<?php the_ID(); ?>" class="w-row sparkline-row">
                                        ...
                                        <div class="w-col w-col-3 spark-column-1">
                                            <div class="featured-image-white-line-border">
                                        ...
                                        <div class="w-col w-col-9 spark-column-2">
                                            <header class="entry-header">
                                                <div class="notation">Featured Blog Post</div>
                        ...
                        <a href="#carousel-featured-content" role="button" data-slide="prev">
                            <div class="w-slider-arrow-left w-hidden-small w-hidden-tiny">
                                <div class="w-icon-slider-left slider-nav-icon"></div>
                            </div>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a href="#carousel-featured-content" role="button" data-slide="next">
