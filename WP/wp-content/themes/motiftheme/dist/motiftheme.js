...
(function($) {
        $(".hero-banner-inline-css").append('<div id="video-container" style="position:relative;"></div>');
        ...
        //$('#start-video').click(showAndPlayVideo, autoplay_mobile);
        ...
        function showAndPlayVideo () {
            ...
            $("#video-container").append('<div id="vimeo-player" style="position:relative;"><div class="vimeo-player-wrapper" style="position:relative;"><iframe id="herovid" width="560" height="315" src="https://www.youtube.com/embed/ZYindgQcbro?autohide=1&showinfo=0&autoplay=1&wmode=transparent" frameborder="0" allowfullscreen></iframe><div class="circle circle-close-x" onclick="hideVideo();" ><div class="close-btn mobile-close">&#10006;</div></div></div></div>');
            resizeVideo();
