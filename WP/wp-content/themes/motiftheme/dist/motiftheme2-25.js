    ...
    _.each(triggers, function(trigger) {
      ...
      if (type == 'click') {
        $el.on('click' + namespace, function(evt) {
          ...
          if ($el.attr('href') === '_#') evt.preventDefault();
...
Webflow.define('scroll', function($) {
  ...
  function ready() {
    ...
    $doc.on('click', 'a', function(e) {
      ...
      // Ignore empty _# links
      if (this.getAttribute('href') === '_#') {
        e.preventDefault();
        return;
      }
  ...
  function findEl(hash, e) {
    ...
    if (loc.hash !== hash && history && history.pushState) {
      ...
      if (oldHash !== hash) {
        history.pushState({ hash: hash }, '', '_#' + hash);
      }
    }
...
Webflow.define('links', function($, _) {
  ...
  function select(link) {
    ...
    if (href.indexOf('_#') === 0 && validHash.test(href)) {
      // Ignore _#edit anchors
      if (href === '_#edit') return;
      var $section = $(href);
...
Webflow.define('navbar', function($, _) {
  ...
  function navigate(data) {
    return function(evt) {
      ...
      if (href && href.indexOf('_#') === 0 && data.open) {
        close(data);
      }
    };
  }
  ...
  api.ready = function() {
    ...
    if (doBranding) {
      ...
      $branding.css({
        ...
        bottom: 0,
        right: 0,
        borderTop: '5px solid _#2b3239',
        borderLeft: '5px solid _#2b3239',
        borderTopLeftRadius: '5px',
        backgroundColor: '_#2b3239',
...
Webflow.require('ix').init([
  {"slug":"scale","name":"Scale","value":{"style":{"scale":0.9},"triggers":[]}},
  {"slug":"hover","name":"Hover","value":{"style":{},"triggers":[{"type":"hover","selector":".feature-image","descend":true,"stepsA":[{"transition":"transform 500ms ease 0ms","scale":1}],"stepsB":[{"transition":"transform 500ms ease 0ms","scale":0.9}]}]}},
  {"slug":"expand","name":"Expand","value":{"style":{},"triggers":[{"type":"click","selector":".search-field-mobile","stepsA":[{"display":"none","height":"0px","transition":"height 500ms ease 0ms"},{"display":"block","height":"42px","transition":"height 500ms ease 0ms"}],"stepsB":[{"display":"block","height":"42px","transition":"height 500ms ease 0ms"},{"display":"none","height":"0px","transition":"height 500ms ease 0ms"}]}]}},
  {"slug":"show-and-hide","name":"Show and Hide","value":{"style":{},"triggers":[{"type":"click","selector":".faq-block","siblings":true,"stepsA":[{"display":"none","height":"0px"},{"display":"block","height":"auto","transition":"height 500ms ease 0ms"}],"stepsB":[{"height":"0px","transition":"height 500ms ease 0ms"},{"display":"none"}]},{"type":"click","selector":".compress-icon","descend":true,"stepsA":[{"display":"none"},{"display":"inline-block"}],"stepsB":[{"display":"inline-block"},{"display":"none"}]},{"type":"click","selector":".expand-icon","descend":true,"stepsA":[{"display":"inline-block"},{"display":"none"}],"stepsB":[{"display":"none"},{"display":"inline-block"}]}]}},
  {"slug":"display-none","name":"Display None","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"show-wsj","name":"Show WSJ","value":{"style":{},"triggers":[{"type":"hover","selector":".wsj-quote","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]},{"type":"hover","selector":".nyt-quote","stepsA":[{"display":"none"}],"stepsB":[{"display":"block"}]}]}},
  {"slug":"show-bloomberg","name":"Show Bloomberg","value":{"style":{},"triggers":[{"type":"hover","selector":".bloom-quote","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]},{"type":"hover","selector":".nyt-quote","stepsA":[{"display":"none"}],"stepsB":[{"display":"block"}]}]}},
  {"slug":"show-cnbc","name":"Show CNBC","value":{"style":{},"triggers":[{"type":"hover","selector":".cnbc-quote","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]},{"type":"hover","selector":".nyt-quote","stepsA":[{"display":"none"}],"stepsB":[{"display":"block"}]}]}},
  {"slug":"show-motley-fool","name":"Show Motley Fool","value":{"style":{},"triggers":[{"type":"hover","selector":".motley-quote","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]},{"type":"hover","selector":".nyt-quote","stepsA":[{"display":"none"}],"stepsB":[{"display":"block"}]}]}},
  {"slug":"show-forbes","name":"Show Forbes","value":{"style":{},"triggers":[{"type":"hover","selector":".forbes-quote","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]},{"type":"hover","selector":".nyt-quote","stepsA":[{"display":"none"}],"stepsB":[{"display":"block"}]}]}},
  {"slug":"show-foo","name":"Show foo","value":{"style":{},"triggers":[{"type":"hover","selector":".foo-quote","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]},{"type":"hover","selector":".nyt-quote","stepsA":[{"display":"none"}],"stepsB":[{"display":"block"}]}]}}
]);

// We don't want scrolling on anchor links!
//scroll = null;
...
(function($) {
    ...
    $( document ).ready(function() {
        $("#video-container").append('<div id="vimeo-player"><div class="vimeo-player-wrapper"><video id="herovid" src="" class="video-js vjs-default-skin" autoplay controls preload="auto" width="100%" height="100%" data-setup=\'{ "techOrder": ["youtube"], "src": "https://www.youtube.com/embed/ZYindgQcbro?autohide=1&showinfo=0&autoplay=1&wmode=opaque" }\'><p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a></p></video><div class="circle circle-close-x" onclick="hideVideo();" ><div class="close-btn mobile-close">&#10006;</div></div></div></div>');                    
            resizeVideo();
...
var v = document.getElementById("herovid");
  v.onclick = function() {
    ...
    console.log('autoplay');
          ...
          //with it
              var myVideo = document.getElementById('herovid');
      ...
      //end of troubel shooting
            function showAndPlayVideo () {
            // Insert the vimeo-player iframe into the video-container
            //$("#video-container").append('<div id="vimeo-player"><div class="vimeo-player-wrapper"><iframe id="herovid" width="560" height="315" src="https://www.youtube.com/embed/ZYindgQcbro?autohide=1&showinfo=0&autoplay=1&wmode=opaque" frameborder="0" allowfullscreen></iframe><div class="circle circle-close-x" onclick="hideVideo();" ><div class="close-btn mobile-close">&#10006;</div></div></div></div>');
$("#video-container").append('<div id="vimeo-player"><div class="vimeo-player-wrapper"><video id="herovid" src="" class="video-js vjs-default-skin" autoplay controls preload="auto" width="560" height="315" data-setup=\'{ "techOrder": ["youtube"], "src": "https://www.youtube.com/embed/ZYindgQcbro?autohide=1&showinfo=0&autoplay=1&wmode=opaque" }\'><p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a></p></video><div class="circle circle-close-x" onclick="hideVideo();" ><div class="close-btn mobile-close">&#10006;</div></div></div></div>');                    
            resizeVideo();
...
/*(function($){
  $('#herovid').css({ width: $(window).innerWidth() + 'px', height: $(window).innerHeight() + 'px' });

$('#video-container').css({ width: $(window).innerWidth() + 'px', height: $(window).innerHeight() + 'px' });
$('#vimeo-player').css({ width: $(window).innerWidth() + 'px', height: $(window).innerHeight() + 'px' });
$('.hero').css({ padding: 0 + 'px', width: $(window).innerWidth() + 'px', height: $(window).innerHeight() + 'px' });
